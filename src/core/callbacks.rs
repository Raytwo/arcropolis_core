...
pub enum ArcCallback {
    ...
    /// Editors are meant to edit the content of a file, either the game's or the user's. They can provide their own filesize ahead of time if they plan on replacing with a larger file.
    // TODO: Make it so a size is not necessary, if possible?
